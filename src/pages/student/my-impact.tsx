                ...
                <section className="pt-8">
                    ...
                    {!loading && !error ? (
                        <>
                            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                                <section className="border border-input bg-white p-5">
                                    <CalendarDays
                                        ...
                                        strokeWidth={1.5}
                                    />
                                    <p className="mt-4 text-[32px] font-bold text-primary">
                            ...
                            <section className="mt-8 border border-input bg-white">
                                <div className="flex flex-col gap-4 border-b border-input px-5 py-5 lg:flex-row lg:items-center lg:justify-between">
                                    <div>
                                        <p className="broadsheet-kicker">
                                            Nhật ký cá nhân
                                        </p>
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        <button
                                            ...
                                            className="inline-flex items-center gap-2 border border-input px-4 py-2 text-[14px] font-semibold text-primary transition hover:bg-muted"
                                        >
                                            <History
                                                className="size-4"
                                                strokeWidth={1.75}
                                    ...
                                    <>
                                        <div className="overflow-x-auto">
                                            <table className="min-w-full border-collapse">
                                                <thead>
                                                    <tr className="border-b border-input bg-muted text-left">
                                                ...
                                                <tbody>
                                                    {pagedRows.map((row) => (
                                                        ...
                                                        >
                                                            ...
                                                            <td className="px-5 py-5 align-top">
                                                                <span className="inline-flex border border-input px-3 py-1 text-[12px] font-semibold uppercase tracking-[0.08em] text-primary">
                                                                    {
                                                                        row.roleLabel
                                                                    }
                                                                </span>
                                                            </td>
                                                            <td className="px-5 py-5 align-top text-[16px] leading-7 text-primary">
                                                                {formatDate(
                                                                    row.occurredAt,
                                                                )}
                                                            </td>
                                        ...
                                        <div className="flex flex-col gap-4 border-t border-input px-5 py-4 lg:flex-row lg:items-center lg:justify-between">
                                            ...
                                            <div className="flex flex-wrap items-center gap-2">
                                                <button
                                                    ...
                                                    className="border border-input px-3 py-2 text-[14px] font-semibold text-primary disabled:cursor-not-allowed disabled:text-[#9CA3AF]"
                                                >
                                                    Trước
                                                </button>
                            ...
                            <section className="mt-8 grid gap-6 xl:grid-cols-[minmax(0,1fr)_420px]">
                                <div className="border border-primary bg-primary p-6 text-white">
                                ...
                                <div className="border border-input bg-white p-6">
                                    <p className="broadsheet-kicker">
                                        Đề xuất tiếp theo
                                    </p>
                                    <h2 className="mt-3 font-heading text-[32px] leading-[1.1] font-bold text-primary">
                                    ...
                                    {recommendedCampaign ? (
                                        <Link
                                            ...
                                            className="mt-6 block border border-input bg-muted p-4 transition hover:border-primary"
                                        >
                                            <div className="grid gap-4 sm:grid-cols-[96px_minmax(0,1fr)] sm:items-center">
                                                <div className="aspect-square border border-input bg-white">
                                                    {recommendedCampaign.cover_image_url ? (
                                                        ...
                                                        <div className="flex h-full items-center justify-center text-[14px] font-semibold text-muted-foreground">
                                                            BK Volunteers
                                                        </div>
                                                    )}
                                                </div>
                                                <div>
                                                    <p className="text-[22px] font-semibold leading-8 text-primary">
                                                        {toDisplayTitle(
                                                            recommendedCampaign.title,
                                                        )}
                                                    </p>
                                        ...
                                        <div className="mt-6 border border-input bg-muted p-4 text-[15px] leading-7 text-muted-foreground">
                                    ...
                                    <Link
                                        ...
                                        className="mt-6 inline-flex items-center gap-2 text-[14px] font-semibold text-primary transition hover:text-destructive"
                                    >
