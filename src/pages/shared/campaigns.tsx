            ...
            <div className="bg-white">
                <section className="border-b border-border pb-6">
                    ...
                    <div className="mt-3 flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
                        ...
                        <div
                            className="inline-flex w-full border border-input bg-white xl:w-auto"
                            role="group"
                ...
                <section className="grid gap-8 pt-8 xl:grid-cols-[300px_minmax(0,1fr)]">
                    <aside className="space-y-6">
                                        ...
                                        {studentStageOptions.map((option) => (
                                            ...
                                            >
                                                <input
                                                    ...
                                                    className="h-4 w-4 border border-input text-primary focus:ring-0"
                                                />
                        ...
                        <div className="border border-primary bg-primary p-5 text-white">
