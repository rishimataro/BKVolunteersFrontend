...
const textareaClassName =
    'min-h-32 w-full border border-[#D1D5DB] bg-white px-3 py-3 text-[16px] leading-7 text-[#0A0A0A] outline-none transition focus:border-2 focus:border-[#0A0A0A]';

const noteSurfaceClassName =
    'border border-[#D1D5DB] bg-[#F9FAFB] p-4 text-[14px] leading-7 text-[#4B5563]';
                        ...
                        <div className="grid gap-8 xl:grid-cols-[320px_minmax(0,1fr)]">
                            <aside className="space-y-5">
                                <article className="border border-[#D1D5DB] bg-white">
                                    <div className="aspect-[4/3] border-b border-[#D1D5DB] bg-[#F9FAFB]">
                                        {campaign.cover_image_url ? (
                                            ...
                                            <div className="flex h-full items-center justify-center px-6 text-center font-heading text-[28px] font-bold text-[#0A0A0A]">
                                                BK Volunteers
                                            </div>
                                        )}
                                    </div>
                                    <div className="space-y-5 p-5">
                                        <div className="border-b border-[#E5E7EB] pb-4">
                                            <span className="inline-flex border border-[#DC2626] px-3 py-1 text-[12px] font-semibold uppercase tracking-[0.16em] text-[#DC2626]">
                                                {campaignStatusLabels[
                                                    campaign.status
                                                ] ?? 'Đang mở đăng ký'}
                                            </span>
                                            <h2 className="mt-3 font-heading text-[30px] leading-[1.15] font-bold text-[#0A0A0A]">
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex items-start gap-3">
                                                <CalendarDays
                                                    className="mt-0.5 size-4 text-[#0A0A0A]"
                                                    strokeWidth={1.75}
                                                />
                                                <div>
                                                    ...
                                                    <p className="mt-2 text-[15px] leading-7 text-[#0A0A0A]">
                                                        {formatDate(
                                        ...
                                        <div className="border-t border-[#E5E7EB] pt-4">
                                            <p className="text-[15px] leading-7 italic text-[#4B5563]">
                                                "{campaignQuote}"
                                            </p>
                                        </div>
                                    </div>
                                ...
                                >
                                    <div className="grid gap-6 md:grid-cols-2">
                                        <div>
                                            ...
                                            <div className="mt-2 border border-[#D1D5DB] bg-[#F9FAFB] px-4 py-3 text-[16px] leading-7 text-[#0A0A0A]">
                                                {studentFullName ||
                                                    'Chưa cập nhật'}
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        <label
                                            ...
                                            className="flex items-start gap-3 border border-[#D1D5DB] bg-[#F9FAFB] p-4"
                                        >
                                            <input
                                                ...
                                                className="mt-1 h-4 w-4 border border-[#D1D5DB] text-[#0A0A0A] focus:ring-0"
                                            />
                                            <span className="text-[14px] leading-7 text-[#4B5563]">
                                        ...
                                        {formErrors.committed ? (
                                            <p className="mt-2 text-[12px] leading-5 text-[#DC2626]">
                                                {formErrors.committed}
                                            </p>
                                        ) : null}
                                    </div>
                                    ...
                                    <div className="flex flex-col gap-3 border-t border-[#E5E7EB] pt-6 sm:flex-row">
                                        ...
                                        <Link
                                            ...
                                            className="inline-flex h-12 items-center justify-center border-2 border-[#0A0A0A] px-8 text-[16px] font-semibold uppercase tracking-[0.08em] text-[#0A0A0A] transition hover:bg-[#F3F4F6]"
                                        >
                                            Hủy bỏ
                                        </Link>
                                    </div>
