...
export const buttonVariants = cva(
    "group/button inline-flex shrink-0 items-center justify-center whitespace-nowrap border border-transparent bg-clip-padding font-semibold uppercase tracking-[0.08em] text-primary transition-colors outline-none select-none focus-visible:border-primary focus-visible:ring-0 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
    {
        variants: {
            variant: {
                default: 'bg-primary text-white hover:bg-[#1F2937]',
                outline:
                    'border-2 border-primary bg-transparent text-primary hover:bg-[#F3F4F6]',
                secondary: 'bg-[#F3F4F6] text-primary hover:bg-[#E5E7EB]',
                ghost: 'bg-transparent text-primary hover:bg-[#F3F4F6]',
