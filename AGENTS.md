...
This project is indexed by GitNexus as **BKVolunteersFrontend** (56179 symbols, 69375 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
Khi sửa frontend, phải đọc và tuân thủ file `broadsheet-DESIGN.md`.

Design style bắt buộc:

- Newspaper/editorial/broadsheet.
- Màu chính: #0A0A0A, #DC2626, #4B5563, #FFFFFF.
- Không border-radius.
- Không shadow.
- Không gradient.
- Không glassmorphism.
- Dùng border, divider, typography và whitespace để tạo phân cấp.
- Body text căn trái.
- Labels/category dùng uppercase nhỏ, tracking nhẹ.
